...
_G.packer_plugins = {
  ...
  ["hibiscus.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/hibiscus.nvim",
  ...
  nvim = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/nvim",
  ...
  ["statusline.lua"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/statusline.lua",
    url = "https://github.com/beauwilliams/statusline.lua"
  },
  ["tangerine.nvim"] = {
    loaded = true,
    path = "/home/gabriel/.local/share/nvim/site/pack/packer/start/tangerine.nvim",
